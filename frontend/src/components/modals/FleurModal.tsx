                    ...
                    <>
                      ...
                      >
                        ...
                        <div style={{ display: 'flex', gap: '4px', alignItems: 'center', marginLeft: '12px', flexShrink: 0 }}>
                          ...
                          {canEdit && (
                            <button onClick={(e) => { e.stopPropagation(); startEditAmend(amendment); }} title="Modifier" style={iconBtnStyle}>✏</button>
                          )}
                          {isAdmin && (
                            <button onClick={(e) => { e.stopPropagation(); handleDeleteAmend(amendment.id); }} title="Supprimer" style={{ ...iconBtnStyle, color: '#e57373' }}>×</button>
                          )}
                        </div>
                      </div>
