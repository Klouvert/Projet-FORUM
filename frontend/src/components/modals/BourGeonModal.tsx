                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <div style={{ display: 'flex', gap: '4px', alignItems: 'center' }}>
                      ...
                      {canEdit && editArgId !== arg.id && (
                        <button onClick={() => startEditArg(arg)} title="Modifier" style={iconBtnStyle}>✏</button>
                      )}
                      {isAdmin && (
                        <button onClick={() => handleDeleteArg(arg.id)} title="Supprimer" style={{ ...iconBtnStyle, color: '#e57373' }}>×</button>
                      )}
                    </div>
                  </div>
                  {editArgId === arg.id ? (
